...
// 1 ️⃣**Giải thích thuật toán(ý tưởng)**2 ️⃣**Chú thích chi tiết từng dòng code**3 ️⃣**Thêm`main`dùng`Scanner`để chạy thử**

// ---

// ##1 ️⃣Giải thích thuật toán(dễ hiểu)

// ###🔍Bài toán nhắc lại(ngắn gọn)

// *Hành lang gồm:

// *`'S'`=ghế*`'P'`=cây*Mỗi đoạn**phải có đúng 2 ghế***Hỏi có**bao nhiêu cách đặt vách ngăn**

// ---

// ###💡Ý tưởng chính của thuật toán này

// *Ta**duyệt từ phải sang trái***Mỗi**cặp ghế(`S S`)**tạo ra**nhiều vị trí đặt vách ngăn***Số cách=**tích**của số vị trí đặt vách giữa các cặp ghế

// 📌Quy tắc quan trọng:

// *Nếu giữa**2 ghế**có`k`ký tự(cây),→có`k`cách đặt vách*Nhân dồn tất cả các cặp ghế lại

// ---

// ###❌Trường hợp trả về 0

// *Không có ghế*Số ghế là**lẻ**

// ---

// ##2 ️⃣Code Java có chú thích chi tiết
...
// Duyệt ngược|
// Dễ tính
// khoảng giữa ghế||`ways*=
// khoảng cách`|
// Nhân số cách||`seatCount^=1`|
// Theo dõi
// cặp ghế||MOD|
// Tránh tràn số|
...
// *🔄
// Viết lại
// thuật toán**dễ hơn (forward + đếm ghế)**
// * 📊 Vẽ sơ đồ minh họa
// * 🤔 So sánh với cách DP Python trước đó

// 👉 cứ nói, mình giải tiếp cho đến khi bạn **hiểu hẳn** 👍
