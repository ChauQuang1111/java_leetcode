...
public class b78 {
    ...
    public static int totalMoney(int n) {
        ...
        // Tổng tiền của các ngày còn lại
        int start = weeks + 1;
...
// # Rất hay 👏 — đây là một bài LeetCode khá cơ bản nhưng dễ nhầm nếu không để
// ý đến quy luật tăng dần.
...
// # ```
// # * Sang **tuần tiếp theo**, bạn lại bắt đầu từ số tiền lớn hơn **1 đô so với
// thứ Hai tuần trước**.
...
// # * ⏱️ `O(1)` (vì có thể tính công thức trực tiếp hoặc `O(n)` nếu dùng vòng
// lặp ngắn)
// # * 💾 `O(1)` bộ nhớ

// # ---

// # Bạn có muốn mình viết luôn **phiên bản Java** của lời giải này + chú thích
// từng dòng không?
...
// # và **minh họa từng vòng lặp chạy ra giá trị cụ thể** nhé — bạn muốn mình
// làm không?
