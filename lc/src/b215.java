...
// ✅ Nếu bạn muốn mình có thể giải thích thêm **2 điểm rất quan trọng của bài
// này**:
...
// * Công nhân `i` **mất `workerTimes[i]` giây để giảm 1 đơn vị chiều cao của
// núi lần đầu**.
...
// Phần này khá **quan trọng trong Binary Search**: ta phải chọn một **giới hạn
// trên (right)** chắc chắn **đủ lớn để phá hết núi**.
...
// Nếu thời gian đủ cho worker này **một mình phá hết núi**, thì chắc chắn **các
// worker khác cùng làm sẽ nhanh hơn**.
...
// Nếu bạn muốn, mình có thể giải thích thêm **2 insight rất hay của bài này**
// (thường hỏi trong FAANG):
...
// Phần **sqrt trong code** xuất phát từ việc **giải bất phương trình bậc 2**.
// Ta đi từng bước để thấy vì sao ra công thức:
...
// Nếu bạn muốn, mình có thể giải thích thêm **một insight rất hay mà nhiều
// người không thấy**:

// 👉 Vì sao bài này **thực chất là bài "K-th smallest element in multiple
// sorted lists"** và có thể giải bằng **priority queue** giống bài **merge k
// sorted arrays**.
