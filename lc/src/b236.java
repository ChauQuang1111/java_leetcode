...
// Đây là lời giải dùng DFS+Đệ quy(Recursion).

// Mình sẽ:

// Giải thích thuật toán

// Thêm chú thích đầy đủ

// Viết thêm hàm main

// Dùng Scanner đúng theo style bạn thích

// Ý tưởng thuật toán

// Mỗi vị trí start là một node.

// Từ node đó có thể đi:

// start+arr[start]

// start-arr[start]

// Ta dùng DFS để thử tất cả đường đi.
...
public class b236 {
    ...
    public static boolean canReach(int[] arr, int start) {
        ...
        // Nếu index ra ngoài mảng

        // hoặc đã duyệt hết các phần tử
        ...
        // Nếu vị trí hiện tại chưa được thăm
             ...
             * 
             * và phần tử cuối mảng = 0
             * 
             * 
             * 
             * => có thể tới cuối mảng
             * 
             */
            ...
            // Thử nhảy sang phải hoặc sang trái
