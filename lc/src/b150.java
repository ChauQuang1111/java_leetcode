...
// Bạn **được phép tháo bỏ một số hàng rào** (không giới hạn số lượng) để **tạo
// ra một hình vuông lớn nhất có thể**.
...
// * Mép trên, dưới, trái, phải của cánh đồng **cũng được coi là hàng rào** (ở
// vị trí 0 và h / w).
...
// 👉 **Tìm diện tích lớn nhất của một hình vuông** có thể tạo ra sau khi tháo
// hàng rào.
...
// nói mình biết nhé 👍
// Mình sẽ **giải thích thuật toán trong đoạn code của bạn**, đi **từng bước
// đúng theo code**, đồng thời chỉ ra **ý tưởng cốt lõi + những điểm cần chú
// ý**.
...
// > Tìm **diện tích hình vuông lớn nhất** có thể tạo ra bằng cách **bỏ hàng
// rào**, sao cho:
