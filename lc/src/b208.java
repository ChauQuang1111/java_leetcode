...
// Ta sẽ phân tích thuật toán của đoạn code Java trong bài **Check if Binary String Has at Most One Segment of Ones**.

// ---

// # 1. Ý tưởng thuật toán

// Chuỗi nhị phân chỉ gồm `0` và `1`.

// Ta cần kiểm tra:

// > Chuỗi có **tối đa 1 đoạn các số `1` liên tiếp**.
...
//    đã bắt đầu **segment thứ hai**
//    → trả về `false`

// 3. Nếu duyệt hết chuỗi mà không vi phạm
//    → trả về `true`.

// ---

// # 2. Code Java có chú thích chi tiết
...
public class b208 {
    ...
    public static void main(String[] args) {
        ...
        // in kết quả
        if (result) {
            System.out.println("Chuoi co toi da 1 segment cua so 1");
        } else {
            System.out.println("Chuoi co nhieu hon 1 segment cua so 1");
        }
    ...
    public static boolean checkOnesSegment(String s) {
        ...
        // f dùng để đánh dấu rằng ta đã gặp số 0
        boolean f = false;
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            // nếu gặp '1' sau khi đã gặp '0'
            // nghĩa là xuất hiện segment 1 thứ hai
            else if (s.charAt(i) == '1' && f) {

                // chuỗi có nhiều hơn 1 segment 1
                return false;
            }
        }

        // nếu duyệt hết chuỗi mà không vi phạm
        // chuỗi có tối đa 1 segment của số 1
        return true;
    }
}
...
// ```
// Nhap chuoi binary: 111000
// ```

// Output

// ```
// Chuoi co toi da 1 segment cua so 1
// ```
...
// ```
// Chuoi co nhieu hon 1 segment cua so 1
// ```
...
// (chỉ dùng 1 biến boolean)

// ---

// ✅ **Điểm hay của thuật toán này:**
// Không cần đếm segment, chỉ cần **phát hiện khi segment thứ hai bắt đầu**.

// ---

// Nếu bạn muốn, mình có thể chỉ thêm **2 cách giải còn ngắn hơn trong Java (1
// dòng hoặc dùng `contains`)** – đây là trick rất hay trong phỏng vấn.

// # Bài **Check if Binary String Has at Most One Segment of Ones** yêu cầu:

// # > Kiểm tra xem chuỗi nhị phân `s` có **tối đa 1 đoạn các số `1` liên tiếp**
// hay không.
...
// # ✅ Nếu bạn muốn, mình có thể giải thích thêm **tại sao `"01"` là trick rất
// hay trong bài này (cách tư duy interview của Google/Meta)** — vì nhiều người
// ban đầu sẽ viết **code dài hơn nhiều**.
...
// # Nếu chuỗi có **"01" rồi lại "10"** → nghĩa là **đã bắt đầu đoạn 1 thứ
// hai**.
...
// # > Kiểm tra xem chuỗi nhị phân có **tối đa 1 đoạn các số 1 liên tiếp** hay
// không.
