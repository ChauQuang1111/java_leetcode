...
// *Thêm**hàm`main`dùng`Scanner`***Giữ nguyên thuật toán bit trick*Thêm**chú thích chi tiết từng dòng**để bạn dễ học+đi thi

// ---

// #🧠Giải thích nhanh lại ý tưởng
...
public class b183 {
    ...
    public static void main(String[] args) {
        ...
        // In kết quả
        if (result) {
            System.out.println(n + " co bit xen ke (Alternating Bits) ✅");
        } else {
            System.out.println(n + " KHONG co bit xen ke ❌");
        }

        sc.close();
    }

    // Hàm kiểm tra số n có bit xen kẽ hay không
    public static boolean hasAlternatingBits(int n) {

        // Bước 1: Dịch phải n 1 bit
        // Ví dụ:
        // n = 10 (1010)
        // n >> 1 = 0101
        int shifted = n >> 1;

        // Bước 2: XOR n với shifted
        ...
        // Bước 3: Kiểm tra n có phải dạng toàn bit 1 không
        //
        // Số dạng:
        // 1 (1)
        // 3 (11)
...
// 1. XOR với số dịch phải
// 2. Nếu ra toàn bit 1 → alternating

// ---

// Nếu bạn muốn mình có thể:

// * Viết lại dùng **while loop kiểm tra từng bit**
// * So sánh **2 cách: bit trick vs duyệt bit**
// * Cho bài tương tự luyện thi LeetCode 🚀

// # Ok 👍 mình sẽ giải thích **ý tưởng thuật toán bit manipulation** này thật
// dễ hiểu rồi thêm **chú thích trực tiếp vào code** cho bạn.
...
// # Nhiệm vụ: kiểm tra xem **dạng nhị phân (binary)** của `n` có phải là **các
// bit xen kẽ nhau** hay không.
