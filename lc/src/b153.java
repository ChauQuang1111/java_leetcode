...
// # Mình sẽ **giải thích thuật toán đúng theo code bạn đưa**, từng khối A – B,
// và chỉ ra **tư duy đằng sau**, để bạn nhìn code là hiểu ngay (đúng kiểu luyện
// LeetCode / phỏng vấn).
...
// # Tìm **độ dài cạnh lớn nhất `k`** của **hình vuông k×k** sao cho **tổng các
// phần tử ≤ threshold**.
...
// # 👉 Nhiệm vụ:
// # **Tìm cạnh lớn nhất `k` của một hình vuông (k × k)** sao cho **tổng các
// phần tử trong hình vuông đó ≤ threshold**.
