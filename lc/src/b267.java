...
// Đây là lời giải Brute Force (O(n²)). Ý tưởng rất đơn giản: với mỗi khoảng, kiểm tra xem có khoảng nào khác bao phủ nó hay không.

// Ý tưởng thuật toán

// Giả sử có hai khoảng:
...
// other bắt đầu trước hoặc bằng current.

// other kết thúc sau hoặc bằng current.

// Thuật toán:



// Ban đầu giả sử tất cả các khoảng đều được giữ lại (remaining = n).

// Duyệt từng khoảng current.

// So sánh với tất cả các khoảng còn lại.

// Nếu tìm thấy một khoảng bao phủ current thì:

// đánh dấu covered = true

// dừng vòng lặp trong (break)

// Nếu covered == true thì giảm remaining.
...
public class b267{
 ...
 public static  int removeCoveredIntervals(int[][] intervals) {
        ...
        // Ban đầu giả sử tất cả các khoảng đều được giữ lại
        ...
        for (int i = 0; i < n; i++) {
            ...
            // So sánh current với tất cả các khoảng khác
            ...
            for (int j = 0; j < n; j++) {
                ...
                // Nếu other bao phủ current

                // c <= a : other bắt đầu trước hoặc bằng current

                // b <= d : other kết thúc sau hoặc bằng current
            ...
            // Nếu current bị bao phủ thì loại bỏ
...
// CurrentCovered?Remaining[1,4]Không3[3,6]Có (bởi [2,8])2[2,8]Không2
...
// Thời gian: O(n²) vì mỗi khoảng được so sánh với tất cả các khoảng còn lại.

// Không gian: O(1) vì chỉ sử dụng một vài biến phụ, không cần cấu trúc dữ liệu bổ sung.